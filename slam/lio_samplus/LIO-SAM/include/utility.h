...
public:
    ...
    ParamServer()
    {
        ...
        nh.param<std::string>("lio_sam/gpsTopic", gpsTopic, "odometry/gps");
         nh.param<std::string>("lio_sam/navsatTopic",navsatTopic, "gps/fixed");
        ...
        nh.param<bool>("lio_sam/updateOrigin", updateOrigin, false);
        nh.param<int>("lio_sam/gpsFrequence", gpsFrequence, 10);
       
      
        nh.param<float>("lio_sam/gpsDistance", GPSDISTANCE, 0.5);
